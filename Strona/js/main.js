;(function () {
	...
	var servicesAnimate = function() {
		...
		var sielankaAnimate = function() {
		var sielanka = $('#fh5co-sielanka');
		if ( sielanka.length > 0 ) {	

			sielanka.waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {


					var sec = sielanka.find('.to-animate').length,
						sec = parseInt((sec * 200) + 400);

					setTimeout(function() {
						sielanka.find('.to-animate').each(function( k ) {
							var el = $(this);
					...
					setTimeout(function() {
						sielanka.find('.to-animate-2').each(function( k ) {
							var el = $(this);
